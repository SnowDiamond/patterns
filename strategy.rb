# Стратегия - поведенческий паттерн, позволяет одним запросом получать от объекта различный результат в зависимости от текущей стратегии(внешних обстоятельств). Стратегия в данном случае это отдельный класс, который присваивается аттрибуту объекта либо при его инициализации либо в процессе работы. 
